...
/*SSTD_QT_SYMBOL_DECL*/
namespace sstd {
    SSTD_QT_SYMBOL_DECL void  _sstd_glActiveShaderProgram(GLuint  pipeline, GLuint  program);
    SSTD_QT_SYMBOL_DECL void  _sstd_glActiveTexture(GLenum  texture);
    SSTD_QT_SYMBOL_DECL void  _sstd_glAttachShader(GLuint  program, GLuint  shader);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBeginConditionalRender(GLuint  id, GLenum  mode);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBeginQuery(GLenum  target, GLuint  id);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBeginQueryIndexed(GLenum  target, GLuint  index, GLuint  id);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBeginTransformFeedback(GLenum  primitiveMode);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindAttribLocation(GLuint  program, GLuint  index, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindBuffer(GLenum  target, GLuint  buffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindBufferBase(GLenum  target, GLuint  index, GLuint  buffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindBufferRange(GLenum  target, GLuint  index, GLuint  buffer, GLintptr  offset, GLsizeiptr  size);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindBuffersBase(GLenum  target, GLuint  first, GLsizei  count, GLuint *  buffers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindBuffersRange(GLenum  target, GLuint  first, GLsizei  count, GLuint *  buffers, GLintptr *  offsets, GLsizeiptr *  sizes);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindFragDataLocation(GLuint  program, GLuint  color, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindFragDataLocationIndexed(GLuint  program, GLuint  colorNumber, GLuint  index, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindFramebuffer(GLenum  target, GLuint  framebuffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindImageTexture(GLuint  unit, GLuint  texture, GLint  level, GLboolean  layered, GLint  layer, GLenum  access, GLenum  format);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindImageTextures(GLuint  first, GLsizei  count, GLuint *  textures);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindProgramPipeline(GLuint  pipeline);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindRenderbuffer(GLenum  target, GLuint  renderbuffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindSampler(GLuint  unit, GLuint  sampler);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindSamplers(GLuint  first, GLsizei  count, GLuint *  samplers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindTexture(GLenum  target, GLuint  texture);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindTextureUnit(GLuint  unit, GLuint  texture);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindTextures(GLuint  first, GLsizei  count, GLuint *  textures);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindTransformFeedback(GLenum  target, GLuint  id);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindVertexArray(GLuint  array);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindVertexBuffer(GLuint  bindingindex, GLuint  buffer, GLintptr  offset, GLsizei  stride);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBindVertexBuffers(GLuint  first, GLsizei  count, GLuint *  buffers, GLintptr *  offsets, GLsizei *  strides);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlendColor(GLfloat  red, GLfloat  green, GLfloat  blue, GLfloat  alpha);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlendEquation(GLenum  mode);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlendEquationSeparate(GLenum  modeRGB, GLenum  modeAlpha);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlendEquationSeparatei(GLuint  buf, GLenum  modeRGB, GLenum  modeAlpha);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlendEquationi(GLuint  buf, GLenum  mode);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlendFunc(GLenum  sfactor, GLenum  dfactor);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlendFuncSeparate(GLenum  sfactorRGB, GLenum  dfactorRGB, GLenum  sfactorAlpha, GLenum  dfactorAlpha);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlendFuncSeparatei(GLuint  buf, GLenum  srcRGB, GLenum  dstRGB, GLenum  srcAlpha, GLenum  dstAlpha);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlendFunci(GLuint  buf, GLenum  src, GLenum  dst);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlitFramebuffer(GLint  srcX0, GLint  srcY0, GLint  srcX1, GLint  srcY1, GLint  dstX0, GLint  dstY0, GLint  dstX1, GLint  dstY1, GLbitfield  mask, GLenum  filter);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBlitNamedFramebuffer(GLuint  readFramebuffer, GLuint  drawFramebuffer, GLint  srcX0, GLint  srcY0, GLint  srcX1, GLint  srcY1, GLint  dstX0, GLint  dstY0, GLint  dstX1, GLint  dstY1, GLbitfield  mask, GLenum  filter);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBufferData(GLenum  target, GLsizeiptr  size, void *  data, GLenum  usage);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBufferStorage(GLenum  target, GLsizeiptr  size, void *  data, GLbitfield  flags);
    SSTD_QT_SYMBOL_DECL void  _sstd_glBufferSubData(GLenum  target, GLintptr  offset, GLsizeiptr  size, void *  data);
    SSTD_QT_SYMBOL_DECL GLenum  _sstd_glCheckFramebufferStatus(GLenum  target);
    SSTD_QT_SYMBOL_DECL GLenum  _sstd_glCheckNamedFramebufferStatus(GLuint  framebuffer, GLenum  target);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClampColor(GLenum  target, GLenum  clamp);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClear(GLbitfield  mask);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearBufferData(GLenum  target, GLenum  internalformat, GLenum  format, GLenum  type, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearBufferSubData(GLenum  target, GLenum  internalformat, GLintptr  offset, GLsizeiptr  size, GLenum  format, GLenum  type, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearBufferfi(GLenum  buffer, GLint  drawbuffer, GLfloat  depth, GLint  stencil);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearBufferfv(GLenum  buffer, GLint  drawbuffer, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearBufferiv(GLenum  buffer, GLint  drawbuffer, GLint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearBufferuiv(GLenum  buffer, GLint  drawbuffer, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearColor(GLfloat  red, GLfloat  green, GLfloat  blue, GLfloat  alpha);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearDepth(GLdouble  depth);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearDepthf(GLfloat  dd);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearNamedBufferData(GLuint  buffer, GLenum  internalformat, GLenum  format, GLenum  type, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearNamedBufferSubData(GLuint  buffer, GLenum  internalformat, GLintptr  offset, GLsizei  size, GLenum  format, GLenum  type, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearNamedFramebufferfi(GLuint  framebuffer, GLenum  buffer, GLint  drawbuffer, GLfloat  depth, GLint  stencil);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearNamedFramebufferfv(GLuint  framebuffer, GLenum  buffer, GLint  drawbuffer, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearNamedFramebufferiv(GLuint  framebuffer, GLenum  buffer, GLint  drawbuffer, GLint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearNamedFramebufferuiv(GLuint  framebuffer, GLenum  buffer, GLint  drawbuffer, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearStencil(GLint  s);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearTexImage(GLuint  texture, GLint  level, GLenum  format, GLenum  type, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClearTexSubImage(GLuint  texture, GLint  level, GLint  xoffset, GLint  yoffset, GLint  zoffset, GLsizei  width, GLsizei  height, GLsizei  depth, GLenum  format, GLenum  type, void *  data);
    SSTD_QT_SYMBOL_DECL GLenum  _sstd_glClientWaitSync(GLsync  sync, GLbitfield  flags, GLuint64  timeout);
    SSTD_QT_SYMBOL_DECL void  _sstd_glClipControl(GLenum  origin, GLenum  depth);
    SSTD_QT_SYMBOL_DECL void  _sstd_glColorMask(GLboolean  red, GLboolean  green, GLboolean  blue, GLboolean  alpha);
    SSTD_QT_SYMBOL_DECL void  _sstd_glColorMaski(GLuint  index, GLboolean  r, GLboolean  g, GLboolean  b, GLboolean  a);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCompileShader(GLuint  shader);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCompressedTexImage1D(GLenum  target, GLint  level, GLenum  internalformat, GLsizei  width, GLint  border, GLsizei  imageSize, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCompressedTexImage2D(GLenum  target, GLint  level, GLenum  internalformat, GLsizei  width, GLsizei  height, GLint  border, GLsizei  imageSize, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCompressedTexImage3D(GLenum  target, GLint  level, GLenum  internalformat, GLsizei  width, GLsizei  height, GLsizei  depth, GLint  border, GLsizei  imageSize, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCompressedTexSubImage1D(GLenum  target, GLint  level, GLint  xoffset, GLsizei  width, GLenum  format, GLsizei  imageSize, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCompressedTexSubImage2D(GLenum  target, GLint  level, GLint  xoffset, GLint  yoffset, GLsizei  width, GLsizei  height, GLenum  format, GLsizei  imageSize, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCompressedTexSubImage3D(GLenum  target, GLint  level, GLint  xoffset, GLint  yoffset, GLint  zoffset, GLsizei  width, GLsizei  height, GLsizei  depth, GLenum  format, GLsizei  imageSize, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCompressedTextureSubImage1D(GLuint  texture, GLint  level, GLint  xoffset, GLsizei  width, GLenum  format, GLsizei  imageSize, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCompressedTextureSubImage2D(GLuint  texture, GLint  level, GLint  xoffset, GLint  yoffset, GLsizei  width, GLsizei  height, GLenum  format, GLsizei  imageSize, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCompressedTextureSubImage3D(GLuint  texture, GLint  level, GLint  xoffset, GLint  yoffset, GLint  zoffset, GLsizei  width, GLsizei  height, GLsizei  depth, GLenum  format, GLsizei  imageSize, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyBufferSubData(GLenum  readTarget, GLenum  writeTarget, GLintptr  readOffset, GLintptr  writeOffset, GLsizeiptr  size);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyImageSubData(GLuint  srcName, GLenum  srcTarget, GLint  srcLevel, GLint  srcX, GLint  srcY, GLint  srcZ, GLuint  dstName, GLenum  dstTarget, GLint  dstLevel, GLint  dstX, GLint  dstY, GLint  dstZ, GLsizei  srcWidth, GLsizei  srcHeight, GLsizei  srcDepth);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyNamedBufferSubData(GLuint  readBuffer, GLuint  writeBuffer, GLintptr  readOffset, GLintptr  writeOffset, GLsizei  size);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyTexImage1D(GLenum  target, GLint  level, GLenum  internalformat, GLint  x, GLint  y, GLsizei  width, GLint  border);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyTexImage2D(GLenum  target, GLint  level, GLenum  internalformat, GLint  x, GLint  y, GLsizei  width, GLsizei  height, GLint  border);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyTexSubImage1D(GLenum  target, GLint  level, GLint  xoffset, GLint  x, GLint  y, GLsizei  width);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyTexSubImage2D(GLenum  target, GLint  level, GLint  xoffset, GLint  yoffset, GLint  x, GLint  y, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyTexSubImage3D(GLenum  target, GLint  level, GLint  xoffset, GLint  yoffset, GLint  zoffset, GLint  x, GLint  y, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyTextureSubImage1D(GLuint  texture, GLint  level, GLint  xoffset, GLint  x, GLint  y, GLsizei  width);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyTextureSubImage2D(GLuint  texture, GLint  level, GLint  xoffset, GLint  yoffset, GLint  x, GLint  y, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCopyTextureSubImage3D(GLuint  texture, GLint  level, GLint  xoffset, GLint  yoffset, GLint  zoffset, GLint  x, GLint  y, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCreateBuffers(GLsizei  n, GLuint *  buffers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCreateFramebuffers(GLsizei  n, GLuint *  framebuffers);
    SSTD_QT_SYMBOL_DECL GLuint  _sstd_glCreateProgram();
    SSTD_QT_SYMBOL_DECL void  _sstd_glCreateProgramPipelines(GLsizei  n, GLuint *  pipelines);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCreateQueries(GLenum  target, GLsizei  n, GLuint *  ids);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCreateRenderbuffers(GLsizei  n, GLuint *  renderbuffers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCreateSamplers(GLsizei  n, GLuint *  samplers);
    SSTD_QT_SYMBOL_DECL GLuint  _sstd_glCreateShader(GLenum  type);
    SSTD_QT_SYMBOL_DECL GLuint  _sstd_glCreateShaderProgramv(GLenum  type, GLsizei  count, GLchar * *  strings);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCreateTextures(GLenum  target, GLsizei  n, GLuint *  textures);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCreateTransformFeedbacks(GLsizei  n, GLuint *  ids);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCreateVertexArrays(GLsizei  n, GLuint *  arrays);
    SSTD_QT_SYMBOL_DECL void  _sstd_glCullFace(GLenum  mode);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDebugMessageCallback(GLDEBUGPROC  callback, void *  userParam);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDebugMessageControl(GLenum  source, GLenum  type, GLenum  severity, GLsizei  count, GLuint *  ids, GLboolean  enabled);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDebugMessageInsert(GLenum  source, GLenum  type, GLuint  id, GLenum  severity, GLsizei  length, GLchar *  buf);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteBuffers(GLsizei  n, GLuint *  buffers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteFramebuffers(GLsizei  n, GLuint *  framebuffers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteProgram(GLuint  program);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteProgramPipelines(GLsizei  n, GLuint *  pipelines);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteQueries(GLsizei  n, GLuint *  ids);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteRenderbuffers(GLsizei  n, GLuint *  renderbuffers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteSamplers(GLsizei  count, GLuint *  samplers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteShader(GLuint  shader);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteSync(GLsync  sync);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteTextures(GLsizei  n, GLuint *  textures);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteTransformFeedbacks(GLsizei  n, GLuint *  ids);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDeleteVertexArrays(GLsizei  n, GLuint *  arrays);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDepthFunc(GLenum  func);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDepthMask(GLboolean  flag);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDepthRange(GLdouble  nearVal, GLdouble  farVal);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDepthRangeArrayv(GLuint  first, GLsizei  count, GLdouble *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDepthRangeIndexed(GLuint  index, GLdouble  n, GLdouble  f);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDepthRangef(GLfloat  n, GLfloat  f);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDetachShader(GLuint  program, GLuint  shader);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDisable(GLenum  cap);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDisableVertexArrayAttrib(GLuint  vaobj, GLuint  index);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDisableVertexAttribArray(GLuint  index);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDisablei(GLenum  target, GLuint  index);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDispatchCompute(GLuint  num_groups_x, GLuint  num_groups_y, GLuint  num_groups_z);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDispatchComputeIndirect(GLintptr  indirect);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawArrays(GLenum  mode, GLint  first, GLsizei  count);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawArraysIndirect(GLenum  mode, void *  indirect);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawArraysInstanced(GLenum  mode, GLint  first, GLsizei  count, GLsizei  instancecount);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawArraysInstancedBaseInstance(GLenum  mode, GLint  first, GLsizei  count, GLsizei  instancecount, GLuint  baseinstance);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawBuffer(GLenum  buf);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawBuffers(GLsizei  n, GLenum *  bufs);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawElements(GLenum  mode, GLsizei  count, GLenum  type, void *  indices);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawElementsBaseVertex(GLenum  mode, GLsizei  count, GLenum  type, void *  indices, GLint  basevertex);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawElementsIndirect(GLenum  mode, GLenum  type, void *  indirect);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawElementsInstanced(GLenum  mode, GLsizei  count, GLenum  type, void *  indices, GLsizei  instancecount);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawElementsInstancedBaseInstance(GLenum  mode, GLsizei  count, GLenum  type, void *  indices, GLsizei  instancecount, GLuint  baseinstance);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawElementsInstancedBaseVertex(GLenum  mode, GLsizei  count, GLenum  type, void *  indices, GLsizei  instancecount, GLint  basevertex);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawElementsInstancedBaseVertexBaseInstance(GLenum  mode, GLsizei  count, GLenum  type, void *  indices, GLsizei  instancecount, GLint  basevertex, GLuint  baseinstance);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawRangeElements(GLenum  mode, GLuint  start, GLuint  end, GLsizei  count, GLenum  type, void *  indices);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawRangeElementsBaseVertex(GLenum  mode, GLuint  start, GLuint  end, GLsizei  count, GLenum  type, void *  indices, GLint  basevertex);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawTransformFeedback(GLenum  mode, GLuint  id);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawTransformFeedbackInstanced(GLenum  mode, GLuint  id, GLsizei  instancecount);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawTransformFeedbackStream(GLenum  mode, GLuint  id, GLuint  stream);
    SSTD_QT_SYMBOL_DECL void  _sstd_glDrawTransformFeedbackStreamInstanced(GLenum  mode, GLuint  id, GLuint  stream, GLsizei  instancecount);
    SSTD_QT_SYMBOL_DECL void  _sstd_glEnable(GLenum  cap);
    SSTD_QT_SYMBOL_DECL void  _sstd_glEnableVertexArrayAttrib(GLuint  vaobj, GLuint  index);
    SSTD_QT_SYMBOL_DECL void  _sstd_glEnableVertexAttribArray(GLuint  index);
    SSTD_QT_SYMBOL_DECL void  _sstd_glEnablei(GLenum  target, GLuint  index);
    SSTD_QT_SYMBOL_DECL void  _sstd_glEndConditionalRender();
    SSTD_QT_SYMBOL_DECL void  _sstd_glEndQuery(GLenum  target);
    SSTD_QT_SYMBOL_DECL void  _sstd_glEndQueryIndexed(GLenum  target, GLuint  index);
    SSTD_QT_SYMBOL_DECL void  _sstd_glEndTransformFeedback();
    SSTD_QT_SYMBOL_DECL GLsync  _sstd_glFenceSync(GLenum  condition, GLbitfield  flags);
    SSTD_QT_SYMBOL_DECL void  _sstd_glFinish();
    SSTD_QT_SYMBOL_DECL void  _sstd_glFlush();
    SSTD_QT_SYMBOL_DECL void  _sstd_glFlushMappedBufferRange(GLenum  target, GLintptr  offset, GLsizeiptr  length);
    SSTD_QT_SYMBOL_DECL void  _sstd_glFlushMappedNamedBufferRange(GLuint  buffer, GLintptr  offset, GLsizei  length);
    SSTD_QT_SYMBOL_DECL void  _sstd_glFramebufferParameteri(GLenum  target, GLenum  pname, GLint  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glFramebufferRenderbuffer(GLenum  target, GLenum  attachment, GLenum  renderbuffertarget, GLuint  renderbuffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glFramebufferTexture(GLenum  target, GLenum  attachment, GLuint  texture, GLint  level);
    SSTD_QT_SYMBOL_DECL void  _sstd_glFramebufferTexture1D(GLenum  target, GLenum  attachment, GLenum  textarget, GLuint  texture, GLint  level);
    SSTD_QT_SYMBOL_DECL void  _sstd_glFramebufferTexture2D(GLenum  target, GLenum  attachment, GLenum  textarget, GLuint  texture, GLint  level);
    SSTD_QT_SYMBOL_DECL void  _sstd_glFramebufferTexture3D(GLenum  target, GLenum  attachment, GLenum  textarget, GLuint  texture, GLint  level, GLint  zoffset);
    SSTD_QT_SYMBOL_DECL void  _sstd_glFramebufferTextureLayer(GLenum  target, GLenum  attachment, GLuint  texture, GLint  level, GLint  layer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glFrontFace(GLenum  mode);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenBuffers(GLsizei  n, GLuint *  buffers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenFramebuffers(GLsizei  n, GLuint *  framebuffers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenProgramPipelines(GLsizei  n, GLuint *  pipelines);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenQueries(GLsizei  n, GLuint *  ids);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenRenderbuffers(GLsizei  n, GLuint *  renderbuffers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenSamplers(GLsizei  count, GLuint *  samplers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenTextures(GLsizei  n, GLuint *  textures);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenTransformFeedbacks(GLsizei  n, GLuint *  ids);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenVertexArrays(GLsizei  n, GLuint *  arrays);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenerateMipmap(GLenum  target);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGenerateTextureMipmap(GLuint  texture);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetActiveAtomicCounterBufferiv(GLuint  program, GLuint  bufferIndex, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetActiveAttrib(GLuint  program, GLuint  index, GLsizei  bufSize, GLsizei *  length, GLint *  size, GLenum *  type, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetActiveSubroutineName(GLuint  program, GLenum  shadertype, GLuint  index, GLsizei  bufsize, GLsizei *  length, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetActiveSubroutineUniformName(GLuint  program, GLenum  shadertype, GLuint  index, GLsizei  bufsize, GLsizei *  length, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetActiveSubroutineUniformiv(GLuint  program, GLenum  shadertype, GLuint  index, GLenum  pname, GLint *  values);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetActiveUniform(GLuint  program, GLuint  index, GLsizei  bufSize, GLsizei *  length, GLint *  size, GLenum *  type, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetActiveUniformBlockName(GLuint  program, GLuint  uniformBlockIndex, GLsizei  bufSize, GLsizei *  length, GLchar *  uniformBlockName);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetActiveUniformBlockiv(GLuint  program, GLuint  uniformBlockIndex, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetActiveUniformName(GLuint  program, GLuint  uniformIndex, GLsizei  bufSize, GLsizei *  length, GLchar *  uniformName);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetActiveUniformsiv(GLuint  program, GLsizei  uniformCount, GLuint *  uniformIndices, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetAttachedShaders(GLuint  program, GLsizei  maxCount, GLsizei *  count, GLuint *  shaders);
    SSTD_QT_SYMBOL_DECL GLint  _sstd_glGetAttribLocation(GLuint  program, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetBooleani_v(GLenum  target, GLuint  index, GLboolean *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetBooleanv(GLenum  pname, GLboolean *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetBufferParameteri64v(GLenum  target, GLenum  pname, GLint64 *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetBufferParameteriv(GLenum  target, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetBufferPointerv(GLenum  target, GLenum  pname, void * *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetBufferSubData(GLenum  target, GLintptr  offset, GLsizeiptr  size, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetCompressedTexImage(GLenum  target, GLint  level, void *  img);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetCompressedTextureImage(GLuint  texture, GLint  level, GLsizei  bufSize, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetCompressedTextureSubImage(GLuint  texture, GLint  level, GLint  xoffset, GLint  yoffset, GLint  zoffset, GLsizei  width, GLsizei  height, GLsizei  depth, GLsizei  bufSize, void *  pixels);
    SSTD_QT_SYMBOL_DECL GLuint  _sstd_glGetDebugMessageLog(GLuint  count, GLsizei  bufSize, GLenum *  sources, GLenum *  types, GLuint *  ids, GLenum *  severities, GLsizei *  lengths, GLchar *  messageLog);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetDoublei_v(GLenum  target, GLuint  index, GLdouble *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetDoublev(GLenum  pname, GLdouble *  data);
    SSTD_QT_SYMBOL_DECL GLenum  _sstd_glGetError();
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetFloati_v(GLenum  target, GLuint  index, GLfloat *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetFloatv(GLenum  pname, GLfloat *  data);
    SSTD_QT_SYMBOL_DECL GLint  _sstd_glGetFragDataIndex(GLuint  program, GLchar *  name);
    SSTD_QT_SYMBOL_DECL GLint  _sstd_glGetFragDataLocation(GLuint  program, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetFramebufferAttachmentParameteriv(GLenum  target, GLenum  attachment, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetFramebufferParameteriv(GLenum  target, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL GLenum  _sstd_glGetGraphicsResetStatus();
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetInteger64i_v(GLenum  target, GLuint  index, GLint64 *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetInteger64v(GLenum  pname, GLint64 *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetIntegeri_v(GLenum  target, GLuint  index, GLint *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetIntegerv(GLenum  pname, GLint *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetInternalformati64v(GLenum  target, GLenum  internalformat, GLenum  pname, GLsizei  bufSize, GLint64 *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetInternalformativ(GLenum  target, GLenum  internalformat, GLenum  pname, GLsizei  bufSize, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetMultisamplefv(GLenum  pname, GLuint  index, GLfloat *  val);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetNamedBufferParameteri64v(GLuint  buffer, GLenum  pname, GLint64 *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetNamedBufferParameteriv(GLuint  buffer, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetNamedBufferPointerv(GLuint  buffer, GLenum  pname, void * *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetNamedBufferSubData(GLuint  buffer, GLintptr  offset, GLsizei  size, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetNamedFramebufferAttachmentParameteriv(GLuint  framebuffer, GLenum  attachment, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetNamedFramebufferParameteriv(GLuint  framebuffer, GLenum  pname, GLint *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetNamedRenderbufferParameteriv(GLuint  renderbuffer, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetObjectLabel(GLenum  identifier, GLuint  name, GLsizei  bufSize, GLsizei *  length, GLchar *  label);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetObjectPtrLabel(void *  ptr, GLsizei  bufSize, GLsizei *  length, GLchar *  label);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetProgramBinary(GLuint  program, GLsizei  bufSize, GLsizei *  length, GLenum *  binaryFormat, void *  binary);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetProgramInfoLog(GLuint  program, GLsizei  bufSize, GLsizei *  length, GLchar *  infoLog);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetProgramInterfaceiv(GLuint  program, GLenum  programInterface, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetProgramPipelineInfoLog(GLuint  pipeline, GLsizei  bufSize, GLsizei *  length, GLchar *  infoLog);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetProgramPipelineiv(GLuint  pipeline, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL GLuint  _sstd_glGetProgramResourceIndex(GLuint  program, GLenum  programInterface, GLchar *  name);
    SSTD_QT_SYMBOL_DECL GLint  _sstd_glGetProgramResourceLocation(GLuint  program, GLenum  programInterface, GLchar *  name);
    SSTD_QT_SYMBOL_DECL GLint  _sstd_glGetProgramResourceLocationIndex(GLuint  program, GLenum  programInterface, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetProgramResourceName(GLuint  program, GLenum  programInterface, GLuint  index, GLsizei  bufSize, GLsizei *  length, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetProgramResourceiv(GLuint  program, GLenum  programInterface, GLuint  index, GLsizei  propCount, GLenum *  props, GLsizei  bufSize, GLsizei *  length, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetProgramStageiv(GLuint  program, GLenum  shadertype, GLenum  pname, GLint *  values);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetProgramiv(GLuint  program, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetQueryIndexediv(GLenum  target, GLuint  index, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetQueryObjecti64v(GLuint  id, GLenum  pname, GLint64 *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetQueryObjectiv(GLuint  id, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetQueryObjectui64v(GLuint  id, GLenum  pname, GLuint64 *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetQueryObjectuiv(GLuint  id, GLenum  pname, GLuint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetQueryiv(GLenum  target, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetRenderbufferParameteriv(GLenum  target, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetSamplerParameterIiv(GLuint  sampler, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetSamplerParameterIuiv(GLuint  sampler, GLenum  pname, GLuint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetSamplerParameterfv(GLuint  sampler, GLenum  pname, GLfloat *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetSamplerParameteriv(GLuint  sampler, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetShaderInfoLog(GLuint  shader, GLsizei  bufSize, GLsizei *  length, GLchar *  infoLog);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetShaderPrecisionFormat(GLenum  shadertype, GLenum  precisiontype, GLint *  range, GLint *  precision);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetShaderSource(GLuint  shader, GLsizei  bufSize, GLsizei *  length, GLchar *  source);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetShaderiv(GLuint  shader, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL const GLubyte * _sstd_glGetString(GLenum  name);
    SSTD_QT_SYMBOL_DECL const GLubyte * _sstd_glGetStringi(GLenum  name, GLuint  index);
    SSTD_QT_SYMBOL_DECL GLuint  _sstd_glGetSubroutineIndex(GLuint  program, GLenum  shadertype, GLchar *  name);
    SSTD_QT_SYMBOL_DECL GLint  _sstd_glGetSubroutineUniformLocation(GLuint  program, GLenum  shadertype, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetSynciv(GLsync  sync, GLenum  pname, GLsizei  bufSize, GLsizei *  length, GLint *  values);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTexImage(GLenum  target, GLint  level, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTexLevelParameterfv(GLenum  target, GLint  level, GLenum  pname, GLfloat *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTexLevelParameteriv(GLenum  target, GLint  level, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTexParameterIiv(GLenum  target, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTexParameterIuiv(GLenum  target, GLenum  pname, GLuint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTexParameterfv(GLenum  target, GLenum  pname, GLfloat *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTexParameteriv(GLenum  target, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTextureImage(GLuint  texture, GLint  level, GLenum  format, GLenum  type, GLsizei  bufSize, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTextureLevelParameterfv(GLuint  texture, GLint  level, GLenum  pname, GLfloat *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTextureLevelParameteriv(GLuint  texture, GLint  level, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTextureParameterIiv(GLuint  texture, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTextureParameterIuiv(GLuint  texture, GLenum  pname, GLuint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTextureParameterfv(GLuint  texture, GLenum  pname, GLfloat *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTextureParameteriv(GLuint  texture, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTextureSubImage(GLuint  texture, GLint  level, GLint  xoffset, GLint  yoffset, GLint  zoffset, GLsizei  width, GLsizei  height, GLsizei  depth, GLenum  format, GLenum  type, GLsizei  bufSize, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTransformFeedbackVarying(GLuint  program, GLuint  index, GLsizei  bufSize, GLsizei *  length, GLsizei *  size, GLenum *  type, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTransformFeedbacki64_v(GLuint  xfb, GLenum  pname, GLuint  index, GLint64 *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTransformFeedbacki_v(GLuint  xfb, GLenum  pname, GLuint  index, GLint *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetTransformFeedbackiv(GLuint  xfb, GLenum  pname, GLint *  param);
    SSTD_QT_SYMBOL_DECL GLuint  _sstd_glGetUniformBlockIndex(GLuint  program, GLchar *  uniformBlockName);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetUniformIndices(GLuint  program, GLsizei  uniformCount, GLchar * *  uniformNames, GLuint *  uniformIndices);
    SSTD_QT_SYMBOL_DECL GLint  _sstd_glGetUniformLocation(GLuint  program, GLchar *  name);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetUniformSubroutineuiv(GLenum  shadertype, GLint  location, GLuint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetUniformdv(GLuint  program, GLint  location, GLdouble *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetUniformfv(GLuint  program, GLint  location, GLfloat *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetUniformiv(GLuint  program, GLint  location, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetUniformuiv(GLuint  program, GLint  location, GLuint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetVertexArrayIndexed64iv(GLuint  vaobj, GLuint  index, GLenum  pname, GLint64 *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetVertexArrayIndexediv(GLuint  vaobj, GLuint  index, GLenum  pname, GLint *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetVertexArrayiv(GLuint  vaobj, GLenum  pname, GLint *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetVertexAttribIiv(GLuint  index, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetVertexAttribIuiv(GLuint  index, GLenum  pname, GLuint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetVertexAttribLdv(GLuint  index, GLenum  pname, GLdouble *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetVertexAttribPointerv(GLuint  index, GLenum  pname, void * *  pointer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetVertexAttribdv(GLuint  index, GLenum  pname, GLdouble *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetVertexAttribfv(GLuint  index, GLenum  pname, GLfloat *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetVertexAttribiv(GLuint  index, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetnCompressedTexImage(GLenum  target, GLint  lod, GLsizei  bufSize, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetnTexImage(GLenum  target, GLint  level, GLenum  format, GLenum  type, GLsizei  bufSize, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetnUniformdv(GLuint  program, GLint  location, GLsizei  bufSize, GLdouble *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetnUniformfv(GLuint  program, GLint  location, GLsizei  bufSize, GLfloat *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetnUniformiv(GLuint  program, GLint  location, GLsizei  bufSize, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glGetnUniformuiv(GLuint  program, GLint  location, GLsizei  bufSize, GLuint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glHint(GLenum  target, GLenum  mode);
    SSTD_QT_SYMBOL_DECL void  _sstd_glInvalidateBufferData(GLuint  buffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glInvalidateBufferSubData(GLuint  buffer, GLintptr  offset, GLsizeiptr  length);
    SSTD_QT_SYMBOL_DECL void  _sstd_glInvalidateFramebuffer(GLenum  target, GLsizei  numAttachments, GLenum *  attachments);
    SSTD_QT_SYMBOL_DECL void  _sstd_glInvalidateNamedFramebufferData(GLuint  framebuffer, GLsizei  numAttachments, GLenum *  attachments);
    SSTD_QT_SYMBOL_DECL void  _sstd_glInvalidateNamedFramebufferSubData(GLuint  framebuffer, GLsizei  numAttachments, GLenum *  attachments, GLint  x, GLint  y, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glInvalidateSubFramebuffer(GLenum  target, GLsizei  numAttachments, GLenum *  attachments, GLint  x, GLint  y, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glInvalidateTexImage(GLuint  texture, GLint  level);
    SSTD_QT_SYMBOL_DECL void  _sstd_glInvalidateTexSubImage(GLuint  texture, GLint  level, GLint  xoffset, GLint  yoffset, GLint  zoffset, GLsizei  width, GLsizei  height, GLsizei  depth);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsBuffer(GLuint  buffer);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsEnabled(GLenum  cap);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsEnabledi(GLenum  target, GLuint  index);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsFramebuffer(GLuint  framebuffer);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsProgram(GLuint  program);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsProgramPipeline(GLuint  pipeline);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsQuery(GLuint  id);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsRenderbuffer(GLuint  renderbuffer);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsSampler(GLuint  sampler);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsShader(GLuint  shader);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsSync(GLsync  sync);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsTexture(GLuint  texture);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsTransformFeedback(GLuint  id);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glIsVertexArray(GLuint  array);
    SSTD_QT_SYMBOL_DECL void  _sstd_glLineWidth(GLfloat  width);
    SSTD_QT_SYMBOL_DECL void  _sstd_glLinkProgram(GLuint  program);
    SSTD_QT_SYMBOL_DECL void  _sstd_glLogicOp(GLenum  opcode);
    SSTD_QT_SYMBOL_DECL void * _sstd_glMapBuffer(GLenum  target, GLenum  access);
    SSTD_QT_SYMBOL_DECL void * _sstd_glMapBufferRange(GLenum  target, GLintptr  offset, GLsizeiptr  length, GLbitfield  access);
    SSTD_QT_SYMBOL_DECL void * _sstd_glMapNamedBuffer(GLuint  buffer, GLenum  access);
    SSTD_QT_SYMBOL_DECL void * _sstd_glMapNamedBufferRange(GLuint  buffer, GLintptr  offset, GLsizei  length, GLbitfield  access);
    SSTD_QT_SYMBOL_DECL void  _sstd_glMemoryBarrier(GLbitfield  barriers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glMemoryBarrierByRegion(GLbitfield  barriers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glMinSampleShading(GLfloat  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glMultiDrawArrays(GLenum  mode, GLint *  first, GLsizei *  count, GLsizei  drawcount);
    SSTD_QT_SYMBOL_DECL void  _sstd_glMultiDrawArraysIndirect(GLenum  mode, void *  indirect, GLsizei  drawcount, GLsizei  stride);
    SSTD_QT_SYMBOL_DECL void  _sstd_glMultiDrawElements(GLenum  mode, GLsizei *  count, GLenum  type, void * *  indices, GLsizei  drawcount);
    SSTD_QT_SYMBOL_DECL void  _sstd_glMultiDrawElementsBaseVertex(GLenum  mode, GLsizei *  count, GLenum  type, void * *  indices, GLsizei  drawcount, GLint *  basevertex);
    SSTD_QT_SYMBOL_DECL void  _sstd_glMultiDrawElementsIndirect(GLenum  mode, GLenum  type, void *  indirect, GLsizei  drawcount, GLsizei  stride);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedBufferData(GLuint  buffer, GLsizei  size, void *  data, GLenum  usage);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedBufferStorage(GLuint  buffer, GLsizei  size, void *  data, GLbitfield  flags);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedBufferSubData(GLuint  buffer, GLintptr  offset, GLsizei  size, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedFramebufferDrawBuffer(GLuint  framebuffer, GLenum  buf);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedFramebufferDrawBuffers(GLuint  framebuffer, GLsizei  n, GLenum *  bufs);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedFramebufferParameteri(GLuint  framebuffer, GLenum  pname, GLint  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedFramebufferReadBuffer(GLuint  framebuffer, GLenum  src);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedFramebufferRenderbuffer(GLuint  framebuffer, GLenum  attachment, GLenum  renderbuffertarget, GLuint  renderbuffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedFramebufferTexture(GLuint  framebuffer, GLenum  attachment, GLuint  texture, GLint  level);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedFramebufferTextureLayer(GLuint  framebuffer, GLenum  attachment, GLuint  texture, GLint  level, GLint  layer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedRenderbufferStorage(GLuint  renderbuffer, GLenum  internalformat, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glNamedRenderbufferStorageMultisample(GLuint  renderbuffer, GLsizei  samples, GLenum  internalformat, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glObjectLabel(GLenum  identifier, GLuint  name, GLsizei  length, GLchar *  label);
    SSTD_QT_SYMBOL_DECL void  _sstd_glObjectPtrLabel(void *  ptr, GLsizei  length, GLchar *  label);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPatchParameterfv(GLenum  pname, GLfloat *  values);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPatchParameteri(GLenum  pname, GLint  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPauseTransformFeedback();
    SSTD_QT_SYMBOL_DECL void  _sstd_glPixelStoref(GLenum  pname, GLfloat  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPixelStorei(GLenum  pname, GLint  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPointParameterf(GLenum  pname, GLfloat  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPointParameterfv(GLenum  pname, GLfloat *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPointParameteri(GLenum  pname, GLint  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPointParameteriv(GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPointSize(GLfloat  size);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPolygonMode(GLenum  face, GLenum  mode);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPolygonOffset(GLfloat  factor, GLfloat  units);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPopDebugGroup();
    SSTD_QT_SYMBOL_DECL void  _sstd_glPrimitiveRestartIndex(GLuint  index);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramBinary(GLuint  program, GLenum  binaryFormat, void *  binary, GLsizei  length);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramParameteri(GLuint  program, GLenum  pname, GLint  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform1d(GLuint  program, GLint  location, GLdouble  v0);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform1dv(GLuint  program, GLint  location, GLsizei  count, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform1f(GLuint  program, GLint  location, GLfloat  v0);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform1fv(GLuint  program, GLint  location, GLsizei  count, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform1i(GLuint  program, GLint  location, GLint  v0);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform1iv(GLuint  program, GLint  location, GLsizei  count, GLint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform1ui(GLuint  program, GLint  location, GLuint  v0);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform1uiv(GLuint  program, GLint  location, GLsizei  count, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform2d(GLuint  program, GLint  location, GLdouble  v0, GLdouble  v1);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform2dv(GLuint  program, GLint  location, GLsizei  count, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform2f(GLuint  program, GLint  location, GLfloat  v0, GLfloat  v1);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform2fv(GLuint  program, GLint  location, GLsizei  count, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform2i(GLuint  program, GLint  location, GLint  v0, GLint  v1);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform2iv(GLuint  program, GLint  location, GLsizei  count, GLint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform2ui(GLuint  program, GLint  location, GLuint  v0, GLuint  v1);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform2uiv(GLuint  program, GLint  location, GLsizei  count, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform3d(GLuint  program, GLint  location, GLdouble  v0, GLdouble  v1, GLdouble  v2);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform3dv(GLuint  program, GLint  location, GLsizei  count, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform3f(GLuint  program, GLint  location, GLfloat  v0, GLfloat  v1, GLfloat  v2);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform3fv(GLuint  program, GLint  location, GLsizei  count, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform3i(GLuint  program, GLint  location, GLint  v0, GLint  v1, GLint  v2);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform3iv(GLuint  program, GLint  location, GLsizei  count, GLint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform3ui(GLuint  program, GLint  location, GLuint  v0, GLuint  v1, GLuint  v2);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform3uiv(GLuint  program, GLint  location, GLsizei  count, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform4d(GLuint  program, GLint  location, GLdouble  v0, GLdouble  v1, GLdouble  v2, GLdouble  v3);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform4dv(GLuint  program, GLint  location, GLsizei  count, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform4f(GLuint  program, GLint  location, GLfloat  v0, GLfloat  v1, GLfloat  v2, GLfloat  v3);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform4fv(GLuint  program, GLint  location, GLsizei  count, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform4i(GLuint  program, GLint  location, GLint  v0, GLint  v1, GLint  v2, GLint  v3);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform4iv(GLuint  program, GLint  location, GLsizei  count, GLint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform4ui(GLuint  program, GLint  location, GLuint  v0, GLuint  v1, GLuint  v2, GLuint  v3);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniform4uiv(GLuint  program, GLint  location, GLsizei  count, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix2dv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix2fv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix2x3dv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix2x3fv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix2x4dv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix2x4fv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix3dv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix3fv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix3x2dv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix3x2fv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix3x4dv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix3x4fv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix4dv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix4fv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix4x2dv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix4x2fv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix4x3dv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProgramUniformMatrix4x3fv(GLuint  program, GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glProvokingVertex(GLenum  mode);
    SSTD_QT_SYMBOL_DECL void  _sstd_glPushDebugGroup(GLenum  source, GLuint  id, GLsizei  length, GLchar *  message);
    SSTD_QT_SYMBOL_DECL void  _sstd_glQueryCounter(GLuint  id, GLenum  target);
    SSTD_QT_SYMBOL_DECL void  _sstd_glReadBuffer(GLenum  src);
    SSTD_QT_SYMBOL_DECL void  _sstd_glReadPixels(GLint  x, GLint  y, GLsizei  width, GLsizei  height, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glReadnPixels(GLint  x, GLint  y, GLsizei  width, GLsizei  height, GLenum  format, GLenum  type, GLsizei  bufSize, void *  data);
    SSTD_QT_SYMBOL_DECL void  _sstd_glReleaseShaderCompiler();
    SSTD_QT_SYMBOL_DECL void  _sstd_glRenderbufferStorage(GLenum  target, GLenum  internalformat, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glRenderbufferStorageMultisample(GLenum  target, GLsizei  samples, GLenum  internalformat, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glResumeTransformFeedback();
    SSTD_QT_SYMBOL_DECL void  _sstd_glSampleCoverage(GLfloat  value, GLboolean  invert);
    SSTD_QT_SYMBOL_DECL void  _sstd_glSampleMaski(GLuint  maskNumber, GLbitfield  mask);
    SSTD_QT_SYMBOL_DECL void  _sstd_glSamplerParameterIiv(GLuint  sampler, GLenum  pname, GLint *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glSamplerParameterIuiv(GLuint  sampler, GLenum  pname, GLuint *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glSamplerParameterf(GLuint  sampler, GLenum  pname, GLfloat  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glSamplerParameterfv(GLuint  sampler, GLenum  pname, GLfloat *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glSamplerParameteri(GLuint  sampler, GLenum  pname, GLint  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glSamplerParameteriv(GLuint  sampler, GLenum  pname, GLint *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glScissor(GLint  x, GLint  y, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glScissorArrayv(GLuint  first, GLsizei  count, GLint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glScissorIndexed(GLuint  index, GLint  left, GLint  bottom, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glScissorIndexedv(GLuint  index, GLint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glShaderBinary(GLsizei  count, GLuint *  shaders, GLenum  binaryformat, void *  binary, GLsizei  length);
    SSTD_QT_SYMBOL_DECL void  _sstd_glShaderSource(GLuint  shader, GLsizei  count, GLchar * *  string, GLint *  length);
    SSTD_QT_SYMBOL_DECL void  _sstd_glShaderStorageBlockBinding(GLuint  program, GLuint  storageBlockIndex, GLuint  storageBlockBinding);
    SSTD_QT_SYMBOL_DECL void  _sstd_glStencilFunc(GLenum  func, GLint  ref, GLuint  mask);
    SSTD_QT_SYMBOL_DECL void  _sstd_glStencilFuncSeparate(GLenum  face, GLenum  func, GLint  ref, GLuint  mask);
    SSTD_QT_SYMBOL_DECL void  _sstd_glStencilMask(GLuint  mask);
    SSTD_QT_SYMBOL_DECL void  _sstd_glStencilMaskSeparate(GLenum  face, GLuint  mask);
    SSTD_QT_SYMBOL_DECL void  _sstd_glStencilOp(GLenum  fail, GLenum  zfail, GLenum  zpass);
    SSTD_QT_SYMBOL_DECL void  _sstd_glStencilOpSeparate(GLenum  face, GLenum  sfail, GLenum  dpfail, GLenum  dppass);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexBuffer(GLenum  target, GLenum  internalformat, GLuint  buffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexBufferRange(GLenum  target, GLenum  internalformat, GLuint  buffer, GLintptr  offset, GLsizeiptr  size);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexImage1D(GLenum  target, GLint  level, GLint  internalformat, GLsizei  width, GLint  border, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexImage2D(GLenum  target, GLint  level, GLint  internalformat, GLsizei  width, GLsizei  height, GLint  border, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexImage2DMultisample(GLenum  target, GLsizei  samples, GLenum  internalformat, GLsizei  width, GLsizei  height, GLboolean  fixedsamplelocations);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexImage3D(GLenum  target, GLint  level, GLint  internalformat, GLsizei  width, GLsizei  height, GLsizei  depth, GLint  border, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexImage3DMultisample(GLenum  target, GLsizei  samples, GLenum  internalformat, GLsizei  width, GLsizei  height, GLsizei  depth, GLboolean  fixedsamplelocations);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexParameterIiv(GLenum  target, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexParameterIuiv(GLenum  target, GLenum  pname, GLuint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexParameterf(GLenum  target, GLenum  pname, GLfloat  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexParameterfv(GLenum  target, GLenum  pname, GLfloat *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexParameteri(GLenum  target, GLenum  pname, GLint  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexParameteriv(GLenum  target, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexStorage1D(GLenum  target, GLsizei  levels, GLenum  internalformat, GLsizei  width);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexStorage2D(GLenum  target, GLsizei  levels, GLenum  internalformat, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexStorage2DMultisample(GLenum  target, GLsizei  samples, GLenum  internalformat, GLsizei  width, GLsizei  height, GLboolean  fixedsamplelocations);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexStorage3D(GLenum  target, GLsizei  levels, GLenum  internalformat, GLsizei  width, GLsizei  height, GLsizei  depth);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexStorage3DMultisample(GLenum  target, GLsizei  samples, GLenum  internalformat, GLsizei  width, GLsizei  height, GLsizei  depth, GLboolean  fixedsamplelocations);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexSubImage1D(GLenum  target, GLint  level, GLint  xoffset, GLsizei  width, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexSubImage2D(GLenum  target, GLint  level, GLint  xoffset, GLint  yoffset, GLsizei  width, GLsizei  height, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTexSubImage3D(GLenum  target, GLint  level, GLint  xoffset, GLint  yoffset, GLint  zoffset, GLsizei  width, GLsizei  height, GLsizei  depth, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureBarrier();
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureBuffer(GLuint  texture, GLenum  internalformat, GLuint  buffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureBufferRange(GLuint  texture, GLenum  internalformat, GLuint  buffer, GLintptr  offset, GLsizei  size);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureParameterIiv(GLuint  texture, GLenum  pname, GLint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureParameterIuiv(GLuint  texture, GLenum  pname, GLuint *  params);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureParameterf(GLuint  texture, GLenum  pname, GLfloat  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureParameterfv(GLuint  texture, GLenum  pname, GLfloat *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureParameteri(GLuint  texture, GLenum  pname, GLint  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureParameteriv(GLuint  texture, GLenum  pname, GLint *  param);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureStorage1D(GLuint  texture, GLsizei  levels, GLenum  internalformat, GLsizei  width);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureStorage2D(GLuint  texture, GLsizei  levels, GLenum  internalformat, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureStorage2DMultisample(GLuint  texture, GLsizei  samples, GLenum  internalformat, GLsizei  width, GLsizei  height, GLboolean  fixedsamplelocations);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureStorage3D(GLuint  texture, GLsizei  levels, GLenum  internalformat, GLsizei  width, GLsizei  height, GLsizei  depth);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureStorage3DMultisample(GLuint  texture, GLsizei  samples, GLenum  internalformat, GLsizei  width, GLsizei  height, GLsizei  depth, GLboolean  fixedsamplelocations);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureSubImage1D(GLuint  texture, GLint  level, GLint  xoffset, GLsizei  width, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureSubImage2D(GLuint  texture, GLint  level, GLint  xoffset, GLint  yoffset, GLsizei  width, GLsizei  height, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureSubImage3D(GLuint  texture, GLint  level, GLint  xoffset, GLint  yoffset, GLint  zoffset, GLsizei  width, GLsizei  height, GLsizei  depth, GLenum  format, GLenum  type, void *  pixels);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTextureView(GLuint  texture, GLenum  target, GLuint  origtexture, GLenum  internalformat, GLuint  minlevel, GLuint  numlevels, GLuint  minlayer, GLuint  numlayers);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTransformFeedbackBufferBase(GLuint  xfb, GLuint  index, GLuint  buffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTransformFeedbackBufferRange(GLuint  xfb, GLuint  index, GLuint  buffer, GLintptr  offset, GLsizei  size);
    SSTD_QT_SYMBOL_DECL void  _sstd_glTransformFeedbackVaryings(GLuint  program, GLsizei  count, GLchar * *  varyings, GLenum  bufferMode);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform1d(GLint  location, GLdouble  x);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform1dv(GLint  location, GLsizei  count, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform1f(GLint  location, GLfloat  v0);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform1fv(GLint  location, GLsizei  count, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform1i(GLint  location, GLint  v0);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform1iv(GLint  location, GLsizei  count, GLint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform1ui(GLint  location, GLuint  v0);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform1uiv(GLint  location, GLsizei  count, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform2d(GLint  location, GLdouble  x, GLdouble  y);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform2dv(GLint  location, GLsizei  count, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform2f(GLint  location, GLfloat  v0, GLfloat  v1);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform2fv(GLint  location, GLsizei  count, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform2i(GLint  location, GLint  v0, GLint  v1);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform2iv(GLint  location, GLsizei  count, GLint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform2ui(GLint  location, GLuint  v0, GLuint  v1);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform2uiv(GLint  location, GLsizei  count, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform3d(GLint  location, GLdouble  x, GLdouble  y, GLdouble  z);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform3dv(GLint  location, GLsizei  count, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform3f(GLint  location, GLfloat  v0, GLfloat  v1, GLfloat  v2);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform3fv(GLint  location, GLsizei  count, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform3i(GLint  location, GLint  v0, GLint  v1, GLint  v2);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform3iv(GLint  location, GLsizei  count, GLint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform3ui(GLint  location, GLuint  v0, GLuint  v1, GLuint  v2);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform3uiv(GLint  location, GLsizei  count, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform4d(GLint  location, GLdouble  x, GLdouble  y, GLdouble  z, GLdouble  w);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform4dv(GLint  location, GLsizei  count, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform4f(GLint  location, GLfloat  v0, GLfloat  v1, GLfloat  v2, GLfloat  v3);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform4fv(GLint  location, GLsizei  count, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform4i(GLint  location, GLint  v0, GLint  v1, GLint  v2, GLint  v3);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform4iv(GLint  location, GLsizei  count, GLint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform4ui(GLint  location, GLuint  v0, GLuint  v1, GLuint  v2, GLuint  v3);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniform4uiv(GLint  location, GLsizei  count, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformBlockBinding(GLuint  program, GLuint  uniformBlockIndex, GLuint  uniformBlockBinding);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix2dv(GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix2fv(GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix2x3dv(GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix2x3fv(GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix2x4dv(GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix2x4fv(GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix3dv(GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix3fv(GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix3x2dv(GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix3x2fv(GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix3x4dv(GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix3x4fv(GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix4dv(GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix4fv(GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix4x2dv(GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix4x2fv(GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix4x3dv(GLint  location, GLsizei  count, GLboolean  transpose, GLdouble *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformMatrix4x3fv(GLint  location, GLsizei  count, GLboolean  transpose, GLfloat *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUniformSubroutinesuiv(GLenum  shadertype, GLsizei  count, GLuint *  indices);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glUnmapBuffer(GLenum  target);
    SSTD_QT_SYMBOL_DECL GLboolean  _sstd_glUnmapNamedBuffer(GLuint  buffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUseProgram(GLuint  program);
    SSTD_QT_SYMBOL_DECL void  _sstd_glUseProgramStages(GLuint  pipeline, GLbitfield  stages, GLuint  program);
    SSTD_QT_SYMBOL_DECL void  _sstd_glValidateProgram(GLuint  program);
    SSTD_QT_SYMBOL_DECL void  _sstd_glValidateProgramPipeline(GLuint  pipeline);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexArrayAttribBinding(GLuint  vaobj, GLuint  attribindex, GLuint  bindingindex);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexArrayAttribFormat(GLuint  vaobj, GLuint  attribindex, GLint  size, GLenum  type, GLboolean  normalized, GLuint  relativeoffset);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexArrayAttribIFormat(GLuint  vaobj, GLuint  attribindex, GLint  size, GLenum  type, GLuint  relativeoffset);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexArrayAttribLFormat(GLuint  vaobj, GLuint  attribindex, GLint  size, GLenum  type, GLuint  relativeoffset);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexArrayBindingDivisor(GLuint  vaobj, GLuint  bindingindex, GLuint  divisor);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexArrayElementBuffer(GLuint  vaobj, GLuint  buffer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexArrayVertexBuffer(GLuint  vaobj, GLuint  bindingindex, GLuint  buffer, GLintptr  offset, GLsizei  stride);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexArrayVertexBuffers(GLuint  vaobj, GLuint  first, GLsizei  count, GLuint *  buffers, GLintptr *  offsets, GLsizei *  strides);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib1d(GLuint  index, GLdouble  x);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib1dv(GLuint  index, GLdouble *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib1f(GLuint  index, GLfloat  x);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib1fv(GLuint  index, GLfloat *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib1s(GLuint  index, GLshort  x);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib1sv(GLuint  index, GLshort *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib2d(GLuint  index, GLdouble  x, GLdouble  y);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib2dv(GLuint  index, GLdouble *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib2f(GLuint  index, GLfloat  x, GLfloat  y);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib2fv(GLuint  index, GLfloat *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib2s(GLuint  index, GLshort  x, GLshort  y);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib2sv(GLuint  index, GLshort *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib3d(GLuint  index, GLdouble  x, GLdouble  y, GLdouble  z);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib3dv(GLuint  index, GLdouble *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib3f(GLuint  index, GLfloat  x, GLfloat  y, GLfloat  z);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib3fv(GLuint  index, GLfloat *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib3s(GLuint  index, GLshort  x, GLshort  y, GLshort  z);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib3sv(GLuint  index, GLshort *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4Nbv(GLuint  index, GLbyte *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4Niv(GLuint  index, GLint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4Nsv(GLuint  index, GLshort *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4Nub(GLuint  index, GLubyte  x, GLubyte  y, GLubyte  z, GLubyte  w);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4Nubv(GLuint  index, GLubyte *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4Nuiv(GLuint  index, GLuint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4Nusv(GLuint  index, GLushort *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4bv(GLuint  index, GLbyte *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4d(GLuint  index, GLdouble  x, GLdouble  y, GLdouble  z, GLdouble  w);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4dv(GLuint  index, GLdouble *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4f(GLuint  index, GLfloat  x, GLfloat  y, GLfloat  z, GLfloat  w);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4fv(GLuint  index, GLfloat *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4iv(GLuint  index, GLint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4s(GLuint  index, GLshort  x, GLshort  y, GLshort  z, GLshort  w);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4sv(GLuint  index, GLshort *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4ubv(GLuint  index, GLubyte *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4uiv(GLuint  index, GLuint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttrib4usv(GLuint  index, GLushort *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribBinding(GLuint  attribindex, GLuint  bindingindex);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribDivisor(GLuint  index, GLuint  divisor);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribFormat(GLuint  attribindex, GLint  size, GLenum  type, GLboolean  normalized, GLuint  relativeoffset);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI1i(GLuint  index, GLint  x);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI1iv(GLuint  index, GLint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI1ui(GLuint  index, GLuint  x);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI1uiv(GLuint  index, GLuint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI2i(GLuint  index, GLint  x, GLint  y);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI2iv(GLuint  index, GLint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI2ui(GLuint  index, GLuint  x, GLuint  y);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI2uiv(GLuint  index, GLuint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI3i(GLuint  index, GLint  x, GLint  y, GLint  z);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI3iv(GLuint  index, GLint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI3ui(GLuint  index, GLuint  x, GLuint  y, GLuint  z);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI3uiv(GLuint  index, GLuint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI4bv(GLuint  index, GLbyte *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI4i(GLuint  index, GLint  x, GLint  y, GLint  z, GLint  w);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI4iv(GLuint  index, GLint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI4sv(GLuint  index, GLshort *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI4ubv(GLuint  index, GLubyte *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI4ui(GLuint  index, GLuint  x, GLuint  y, GLuint  z, GLuint  w);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI4uiv(GLuint  index, GLuint *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribI4usv(GLuint  index, GLushort *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribIFormat(GLuint  attribindex, GLint  size, GLenum  type, GLuint  relativeoffset);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribIPointer(GLuint  index, GLint  size, GLenum  type, GLsizei  stride, void *  pointer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribL1d(GLuint  index, GLdouble  x);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribL1dv(GLuint  index, GLdouble *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribL2d(GLuint  index, GLdouble  x, GLdouble  y);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribL2dv(GLuint  index, GLdouble *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribL3d(GLuint  index, GLdouble  x, GLdouble  y, GLdouble  z);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribL3dv(GLuint  index, GLdouble *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribL4d(GLuint  index, GLdouble  x, GLdouble  y, GLdouble  z, GLdouble  w);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribL4dv(GLuint  index, GLdouble *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribLFormat(GLuint  attribindex, GLint  size, GLenum  type, GLuint  relativeoffset);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribLPointer(GLuint  index, GLint  size, GLenum  type, GLsizei  stride, void *  pointer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribP1ui(GLuint  index, GLenum  type, GLboolean  normalized, GLuint  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribP1uiv(GLuint  index, GLenum  type, GLboolean  normalized, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribP2ui(GLuint  index, GLenum  type, GLboolean  normalized, GLuint  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribP2uiv(GLuint  index, GLenum  type, GLboolean  normalized, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribP3ui(GLuint  index, GLenum  type, GLboolean  normalized, GLuint  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribP3uiv(GLuint  index, GLenum  type, GLboolean  normalized, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribP4ui(GLuint  index, GLenum  type, GLboolean  normalized, GLuint  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribP4uiv(GLuint  index, GLenum  type, GLboolean  normalized, GLuint *  value);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexAttribPointer(GLuint  index, GLint  size, GLenum  type, GLboolean  normalized, GLsizei  stride, void *  pointer);
    SSTD_QT_SYMBOL_DECL void  _sstd_glVertexBindingDivisor(GLuint  bindingindex, GLuint  divisor);
    SSTD_QT_SYMBOL_DECL void  _sstd_glViewport(GLint  x, GLint  y, GLsizei  width, GLsizei  height);
    SSTD_QT_SYMBOL_DECL void  _sstd_glViewportArrayv(GLuint  first, GLsizei  count, GLfloat *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glViewportIndexedf(GLuint  index, GLfloat  x, GLfloat  y, GLfloat  w, GLfloat  h);
    SSTD_QT_SYMBOL_DECL void  _sstd_glViewportIndexedfv(GLuint  index, GLfloat *  v);
    SSTD_QT_SYMBOL_DECL void  _sstd_glWaitSync(GLsync  sync, GLbitfield  flags, GLuint64  timeout);
}
